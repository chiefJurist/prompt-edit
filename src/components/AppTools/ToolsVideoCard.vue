...
import vidA from '../../assets/Videos/VideoTools/clone-videos.mp4'
import vidB from '../../assets/Videos/VideoTools/visual-effects.mp4'
import vidC from '../../assets/Videos/VideoTools/cinematic-videos.mp4'
import vidD from '../../assets/Videos/VideoTools/video-ads.mp4'
import vidE from '../../assets/Videos/VideoTools/reels-&-tiktok.mp4'
import vidF from '../../assets/Videos/VideoTools/youtube-videos.mp4'

const videos = ref([
    { id: 1, name: 'Clone Videos', url: vidA },
    { id: 2, name: 'Visual Effects', url: vidB },
    { id: 3, name: 'Cinematic Films', url: vidC },
    { id: 4, name: 'Video Ads', url: vidD },
    { id: 5, name: 'Reels & TikTok', url: vidE },
    { id: 6, name: 'YouTube Videos', url: vidF },
])
    ...
    >
        ...
        <div class="flex flex-col gap-2.5 p-5">
            ...
            <p class="text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                Generate clone videos, cinematic clips, visual effects, video ads, and social-ready
